...
const FlipPage = () => {
  ...
  return (
    <div>
        ...
        component={<div className='flex gap-8 flex-col md:flex-row'>
            <LightCard imageUrl="/icons/photos.png" label="Photos" />
            <LightCard imageUrl="/icons/discord.png" label="Discord" />
        </div>}/>
    </div>
  )
}
